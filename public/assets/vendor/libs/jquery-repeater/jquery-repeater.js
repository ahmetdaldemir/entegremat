                ...
                !function (t) {
                    ...
                    !function (t) {
                        var e = function (t, e) {
                            ...
                            var n = {}, a = e.$, c = e.constructorOverride || {
                                button: s,
                                text: x,
                                url: T,
                                email: l,
                                ...
                                var f = [], s = r(o) ? o : a.find(o);
                                r(o) ? n[s.attr("name")] = c[e]({$: s}) : (s.each((function () {
                        ...
                        return r = r || {}, t(this).each((function () {
                            var f = t(this), s = r.show || function () {
                                    t(this).show()
                                }, p = r.hide || function (t) {
                                    t()
                                }, l = f.find("[data-repeater-list]").first(), h = function (e, n) {
                                    return e.filter((function () {
                                        return !n || 0 === t(this).closest((e = n, "selector", o(e, (function (t) {
                                            return t.selector
                                        }))).join(",")).length;
                                        var e
                                    }))
                            ...
                            var g = function () {
                                ...
                                e.each((function (e) {
                                    ...
                                    i.data("item-name", n + "[" + e + "]"), h(i.find("[name]"), r).each((function () {
                                        var u = t(this), c = u.attr("name").match(/\[[^\]]+\]/g),
